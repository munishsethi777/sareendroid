...
public class NotesFragment extends Fragment implements IServiceHandler {
    ...
    public static NotesFragment newInstance(AdminMgr mAdminMgr, NotesActivity parent) {
        NotesFragment fragment = new NotesFragment();
        int mLoggedInUserSeq = mAdminMgr.getLoggedInAdminSeq();
            ...
            if(success) {
                if (mCallName.equals(GET_ALL_NOTES)) {
                    ...
                    for (int i = 0; i < notesJsonArr.length(); i++) {
                        ...
                        if(noteDetails.length() > 20) {
                            noteDetails = noteDetails.substring(0, 20) + "...";
                        }
